...
public class RegexValidator {
 ...
 public boolean validateUsername(String username) {
  if(username.compareTo("") == 0 || !username.matches("^[a-z0-9_.-]{3,15}$")) {
   return false;
  }
  return true;
 }
 ...
 public boolean validateDomain(String domain) {
  String ValidIP = "^([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\." + "([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\." + "([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\."
